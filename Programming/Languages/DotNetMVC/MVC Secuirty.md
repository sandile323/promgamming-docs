There are 3 ways of making an app secure and these features come with ASP.NET

## Authentification


When creating your app in vs you can select the individual, work or school or  windows authentification. Code generated by VS for authentification:
...
Based on the above a user may have access to a controller or its actions based on the Authorize attribute
...
namespace MVCSecurityDemo.Controllers{
   [Authorize] // no user who arent memebers
   ...
   public class SecretController : Controller{
      ...
      [AllowAnonymous] //allows override to anyuser
